...
const Updateprofile = () => {
  ...
  const senddetails = async () => {
    ...
    try {
      ...
      else setwrong("*some error occured");
    }
  };
  return (
    <>
      <div className=" md:mt-28 mt-5 border border-black p-5 md:w-1/3 ml-auto mr-auto  sm:w-2/4 w-3/5 ">
        <p className="md:text-2xl text-lg text-red-500">{wrong}</p>
        <p className="md:text-4xl text-2xl font-bold mb-3 ">Profile Update</p>
        <form
          action="/signin"
          onSbu
